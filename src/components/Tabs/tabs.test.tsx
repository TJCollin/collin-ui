...
describe('Tabs', ()=>{
	...
	const generateTabs = (props: TabsProps) => {
		return <Tabs {...props}>
			<TabItem label="tab1" index="tab1" className="test-tab-item-class">default tabItem</TabItem>
			<TabItem label="tab2" disaled>disabled tabItem</TabItem>
			<TabItem label={<button>tab3</button>} disaled >customized tabItem</TabItem>
		</Tabs>
	}
	...
	let wrapper: RenderResult, cardWrraper: RenderResult,tabsEl:HTMLElement, normalEl: HTMLElement, disabledEL : HTMLElement, customizedBtn: HTMLElement
	beforeEach(()=>{
